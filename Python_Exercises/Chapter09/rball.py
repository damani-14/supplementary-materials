# rball.py
# Monte Carlo simulation for raquetball games given user provided n and player win probabilities
...
def simOneGame(probA, probB):
    # Simulates a single game of raquetball between players whose
    #    abilities are represented by the probability of winning a serve.
